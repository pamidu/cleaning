(function () {
  ...
  var duoworldFrameworksShellLauncherCompanyManagerControl = function ($rootScope, $scope, $state, $http, $timeout, $objectstore, $uploader, $mdToast, $window, $auth, $mdDialog, $mdMedia) {
  ...
  duoworldFrameworksShellLauncherCompanyManagerControl.$inject = ['$rootScope', '$scope', '$state', '$http', '$timeout', '$presence', '$objectstore', '$uploader', '$mdToast', '$window', '$auth', '$mdDialog', '$mdMedia'];

  mambatiFrameworkShell.controller('duoworld-framework-shell-launcher-companymanager-ctrl', duoworldFrameworksShellLauncherCompanyManagerControl);
}());
